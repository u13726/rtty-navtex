...
public:
 ...
 private:
    ...
    int m_sample_count;
    float m_bit_sample_count;

    float m_early_accumulator;
    float m_prompt_accumulator;
    float m_late_accumulator;

    float m_next_early_event;
    float m_next_prompt_event;
    float m_next_late_event;
    float m_average_early_signal;
    float m_average_prompt_signal;
    float m_average_late_signal;
    ...
    float envelope_decay(float avg, float value);
    float noise_decay(float avg, float value);
